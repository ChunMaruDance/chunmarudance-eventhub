...
import com.chunmaru.eventhub.screens.profile_screen.profile_screen_element.ModalSheetContent
import com.chunmaru.eventhub.screens.profile_screen.profile_screen_element.ProfileCard
import com.chunmaru.eventhub.screens.profile_screen.profile_screen_element.ProfileRowEventsCard
import com.chunmaru.eventhub.screens.profile_screen.profile_screen_element.SignOutAlertDialog
...
fun ProfileScreen(
    ...
    when (val localeState = state.value) {
        ...
        ProfileScreenState.PendingResult -> {
            DefaultProgressBar()
        }

        is ProfileScreenState.ShowProfile -> {
            ...
            SwipeRefresh(state = swipeRefreshState,
                ...
                LazyColumn(
                    ...
                    item {
                        ...
                        ProfileCard(
                            avatarUri = localeState.author.avatar.uri,
                            userName = localeState.author.name,
                            userDescription = localeState.author.description,
                            onMoreClick = {
                                openBottomSheet.value = true
                            },
                            onEditProfile = {
                                onChangeProfileClick(localeState.author)
                            },
                            onAddEvent = {
                                onCreateEventClick()
                            }
                    ...
                    item {
                        Log.d("MyTag", "ProfileScreen: ${localeState.authorEvents} ")
                        ProfileRowEventsCard(
                            events = localeState.authorEvents,
                        ...
                        AnimatedVisibility(
                            ...
                            Column {
                                ModalSheetContent(
                                    ...
                                    showAdminPanel = localeState.isAdmin
                                )
